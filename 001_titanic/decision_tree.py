...
def calc_type_01(df_train:pd.DataFrame,df_test:pd.DataFrame,file_path:str)-> pd.DataFrame:
    # 「train」の目的変数と説明変数の値を取得
    target = df_train["Survived"].values
    features_one = df_train[["Pclass", "Sex", "Age", "Fare","SibSp","Parch","Embarked"]].values
    ...
    # 「test」の説明変数の値を取得
    test_features = df_test[["Pclass", "Sex", "Age", "Fare","SibSp","Parch","Embarked"]].values
